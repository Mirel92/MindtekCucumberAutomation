...
public class WebOrdersSteps {
    ...
    public void userNavigatesToTheOrderModules() {
        webOrdersHomePage.orderModule.click();

    }

    @And("user selects {string} product with {int}")
    ...
    public void userValidatesTotalIsCalculatedProperlyForQuantityQuantity(Integer quantity) {
    ...
    public void userValidatesOrderAddedToListOfOrders() {
        ...
        Assert.assertEquals(numberOfRows+1,numberOfRowsAfterOrderCreation);
